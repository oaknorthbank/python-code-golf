from hole10.banded_tax_calculator import BandedTaxCalculator
from hole10.null_tax_calculator import NullTaxCalculator
from hole10.payslip import Payslip
    ...
    payslip: Payslip = Payslip(gross,
                               BandedTaxCalculator(40000, 0.4,
                                                   BandedTaxCalculator(20000, 0.2,
                                                                       BandedTaxCalculator(5000, 0.1, NullTaxCalculator()))))
